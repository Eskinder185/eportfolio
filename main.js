...
const projects = [
    {
        title: 'JohnnyCloud',
        description: 'An intelligent file processing pipeline built on AWS. When a user uploads files to an S3 bucket, JohnnyCloud triggers Lambda functions to process the files, store results, and send notifications via SNS. It makes heavy use of IAM roles, CloudWatch logs and metrics to ensure observability and security.',
